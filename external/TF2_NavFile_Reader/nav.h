...
enum NavAttributeType
{
    ...
    NAV_MESH_LAST_CUSTOM = 0x04000000,  // apps must not define custom app-specific bits higher than
                                        // with this value

    NAV_MESH_HAS_ELEVATOR = 0x40000000, // area is in an elevator's path
    NAV_MESH_NAV_BLOCKER  = 0x80000000, // area is blocked by nav blocker ( Alas, needed to hijack a
